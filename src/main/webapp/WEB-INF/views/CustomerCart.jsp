    ...
    <table border="1" cellpadding="5" cellspacing="5">
            ...
            <c:forEach var="adv" items="${cartitem}">
                ...
                <td>${adv.cartId}</td>
                    ...
                    <td>  <a href="Checkout.htm?orderStatus=${adv.orderStatus}&total=${adv.total}&cartId=${adv.cartId}&productID=${adv.product.productID}&quantity=${adv.quantity}">Payment</a></td>
