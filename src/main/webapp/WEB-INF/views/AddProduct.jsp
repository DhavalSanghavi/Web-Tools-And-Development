...
<div id="templatemo_container">
	<div id="templatemo_menu">
    	<ul>
            ...
            <li><a href="loginuser.htm">LOGIN</a></li>
...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
    ...
    <form:form style=" color : orange;" commandName="p" action="AddProduct.htm" method="post" enctype="multipart/form-data" >
<p><h2>Product Description:</h2><br>
<form:input type="text" name="productDescription" path="productDescription"/><form:errors path="productDescription"/>
<p><h2>Product Name:</h2><br>
<form:input type="text" name="productname" path="productname"/><form:errors path="productname"/>
<p><h2>Product Price:</h2><br>
<form:input type="text" name="productprice" path="productprice"/><form:errors path="productprice"/>
<p><h2>Seller Quantity:</h2><br>
<form:input type="text" name="sellerQuantity" path="sellerQuantity"/><form:errors path="sellerQuantity"/>
<p><h2>Product Photo:</h2><br>
<form:input type="file"  name="photo" path="photo"/> <form:errors path="photo"/><br>
<input type='checkbox' name='rememberMe' value="rememberMe"> 
            ...
            <a href="subpage.html"><img src="resources/images/templatemo_ads.jpg" alt="ads" /></a>
